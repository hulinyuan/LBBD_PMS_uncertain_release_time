...
def BCK_EAC_main(jobs_num, machines_num, jobtabu, cost, process_time, release_time_mu,
    ...
    global  sp_tm, sp_num, rel_tm, rel_num, mip_tm, mip_num, bk_cuts,int_num,opt_x,opt_y
    ...
    mp_Model.Params.MIPGap = 0.00001
