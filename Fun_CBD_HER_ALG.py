...
主模块
'''
def  CBD_HER_main(jobs_num, machines_num, jobtabu, cost, process_time, release_time_mu, release_time_delta, Gamma, DT, cb_cuts, max_iter, max_time):
    start_time = time.time()   # 算法计时

    global  sp_tm, sp_num, rel_tm, rel_num,  bk_cuts
